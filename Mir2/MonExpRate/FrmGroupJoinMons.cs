...
{
    public partial class FrmGroupJoinMons : UIForm2
    {
        ...
        public FrmGroupJoinMons(List<Monster> listMons, string defMirPath, string mirPath, string groupItemName)
        {
            InitializeComponent();
            ...
            this.Text = $"【[分组]{groupItemName}】怪物选择";
        }

        private void FrmGroupJoinMons_Load(object sender, EventArgs e)
        {
            BindlbMonGroup();
        }
