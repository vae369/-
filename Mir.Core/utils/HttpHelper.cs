...
namespace Mir.Core.utils
{
    public class HttpHelper
    {
        ...
        /// <returns></returns>
        public string SendRequest(string url, ref Dictionary<string, object> data, HttpMethod requestMethod, ref Dictionary<string, string> header, int timeOut = -1, string localPath = null, long offset = -1, int sliceSize = 0)
        {
            try
            {
